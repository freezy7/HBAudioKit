...
const int kHBMaxChannelCount = 16;
...
@implementation HBBufferedAudioUnit {
    float               *_inputBuffer;
    float               *_ouputBuffer;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __unsafe_unretained HBBufferedAudioUnit *welf = self;
    return  ^AUAudioUnitStatus(AudioUnitRenderActionFlags    *actionFlags,
        ...
        assert(channelCount <= kHBMaxChannelCount);
